...
class ValidadorKFoldDeslizante : public Validador
{
    public:
        ...
        vector< vector< float > > executarExperimento3( Treinador &treinador, Corpus &corpus, int atributoTreino, int atributoTeste, int tam_treino, string ativo, int jan, string alg );
