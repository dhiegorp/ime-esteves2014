...
vector<string> valores_codigoativo(51); //51 -vetor dos ativos a serem testados
...
//        classes.push_back("+1");
//
//        outfileK.open("../outputs/saida_analiseparametros.txt", fstream::out);
//        outfileK.clear();
//
